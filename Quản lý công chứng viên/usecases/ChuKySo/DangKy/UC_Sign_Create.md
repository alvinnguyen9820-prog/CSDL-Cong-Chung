...
- Người dùng nhập thông tin: Công chứng viên, Gói đăng ký, Nhà cung cấp, Ngày hiệu lực, Ngày hết hạn, File đính kèm.
- Hệ thống kiểm tra dữ liệu hợp lệ (thời gian hiệu lực/hết hạn, file đúng định dạng).
- Nếu hợp lệ: lưu hồ sơ đăng ký ở trạng thái **"Nháp" hoặc "Chờ gửi duyệt"**.
...
5. Hệ thống kiểm tra dữ liệu:
   - Nếu hợp lệ: lưu dữ liệu vào bảng **ChuKySo** với trạng thái = "Nháp".
   - Hiển thị thông báo "Đăng ký chữ ký số thành công".
